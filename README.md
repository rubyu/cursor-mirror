...
Left-click the notification-area icon, or choose `Settings` from the context menu, to adjust prediction, movement translucency, and idle fade. The settings window also includes an `Exit Cursor Mirror` command.
