#!/usr/bin/env python
"""Run v18 Step 04 C# brake gate search."""
...
STEP = ROOT / "poc" / "cursor-prediction-v18" / "step-04-brake-gate-search"
...
def main() -> int:
    ...
    for args in ([dotnet, "build", str(PROJECT)], [dotnet, "run", "--project", str(PROJECT), "--", str(CONFIG)]):
