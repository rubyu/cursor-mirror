...
static class Program
{
    ...
    static int Main(string[] args)
    {
        ...
        var output = new
        {
            schemaVersion = "cursor-prediction-v21-step-06-deployment-gate-analysis/1",
    ...
    static Config DefaultConfig() => new(
        ...
        ScoresPath: "poc/cursor-prediction-v21/step-06-deployment-gate-analysis/scores.json",
