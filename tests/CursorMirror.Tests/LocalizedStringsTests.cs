    ...
    internal static class LocalizedStringsTests
    {
        ...
        private static void LocalizedUserVisibleStrings()
        {
            ...
            try
            {
                ...
                TestAssert.Equal("ConstantVelocity", LocalizedStrings.PredictionModelOptionText(CursorMirrorSettings.DwmPredictionModelConstantVelocity), "English constant velocity option");
                TestAssert.Equal("LeastSquares (default)", LocalizedStrings.PredictionModelOptionText(CursorMirrorSettings.DwmPredictionModelLeastSquares), "English least-squares option");
                ...
                TestAssert.Equal("ConstantVelocity", LocalizedStrings.PredictionModelOptionText(CursorMirrorSettings.DwmPredictionModelConstantVelocity), "Japanese constant velocity option");
                TestAssert.Equal("LeastSquares (default)", LocalizedStrings.PredictionModelOptionText(CursorMirrorSettings.DwmPredictionModelLeastSquares), "Japanese least-squares option");
